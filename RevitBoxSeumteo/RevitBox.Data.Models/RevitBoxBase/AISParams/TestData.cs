...
namespace RevitBox.Data.Models.RevitBoxBase.AISParams
{
    ...
    public class TestData : BindableBase
    {
        ...
        public IList<AISParams_Type> AISParamsTypeCreate()
        {
            TestParamsTypeList.Clear();
        ...
        public IList<AISParams_Value> AISParamsValueCreate()
        {
            TestParamsValueList.Clear();
