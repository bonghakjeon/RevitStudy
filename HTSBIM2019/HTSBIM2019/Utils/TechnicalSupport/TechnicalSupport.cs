...
namespace HTSBIM2019.Utils.TechnicalSupport
{
    public class TechnicalSupport
    {
        ...
        /// <summary>
        /// C# 기술지원 문의 웹사이트(상상플렉스 커뮤니티) 연결하기 
        /// </summary>
        private void ConnectSangSangFlex(Document rvDoc, string pUrl)
        {
            ...
            try
            {
                ...
                using (Transaction transaction = new Transaction(rvDoc))
                {
                    ...
                    // TODO : C# 기술지원 문의 웹사이트(상상플렉스 커뮤니티) 팝업 화면 출력 구현 (2024.04.11 jbh)
                    // 참고 URL   - https://yongtech.tistory.com/58
                    // 참고 2 URL - https://findfun.tistory.com/485

                    // TODO : C# 기술지원 문의 웹사이트(상상플렉스 커뮤니티) 구글 크롬(chrome.exe)으로 출력 구현 (2024.04.11 jbh)
                    ...
                    // TODO : .net FrameWork 말고 .net Core 6.0 이상 버전에서 C# 기술지원 문의 웹사이트(상상플렉스 커뮤니티) 출력 오류시 아래 처럼 구현 (2024.04.11 jbh)
