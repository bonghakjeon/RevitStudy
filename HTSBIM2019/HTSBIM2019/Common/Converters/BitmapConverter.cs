...
namespace HTSBIM2019.Common.Converters
{
    public class BitmapConverter
    {
        #region ConvertFromBitmap

        // TODO : static 메서드 "CreateRibbonControl"에서 메서드 "ConvertFromBitmap" 호출하기 위해 메서드 "ConvertFromBitmap"을 static 메서드로 구현 (2024.04.12 jbh) 
        ...
        // TODO : 클래스 "BitmapSource", "Bitmap" 사용하기 위해 using문 "System.Windows.Media.Imaging" 추가 (2024.04.12 jbh)
        /// <summary>
        /// 리소스에 등록된 이미지 파일(.png, .jpg 등등...)을 BitmapSource으로 convert 처리 해주는 메서드 
        /// </summary>
        public static BitmapSource ConvertFromBitmap(Bitmap pBitmap)
        {
