    ...
    public class DirectoryManager
    {
        ...
        public static string GetDllParentDirectoryPath(string pAssemblyFilePath)
        {
            ...
            try
            {
                ...
                parentDirPath = Path.GetDirectoryName(pAssemblyFilePath);  // DLL 파일(HTSBIM2019.dll)의 바로 위 상위 디렉토리(폴더명 - "Debug" 또는 "dll") 경로 가져오기

                // 2. DLL 파일의 상위 디렉토리(폴더명 - "HTSBIM2019") 가져오기 
