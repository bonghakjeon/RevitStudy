    ...
    public class ParamsManager
    {
        ...
        public static List<Updater_Parameters> GetMEPUpdaterParameterList(string pDllFilePath)
        {
            ...
            try
            {
                ...
                sb.Append(UpdaterHelper.MEPUpdaterJsonFilePath);
                // sb.Append(@"\Json");
                ...
                JArray jArray = jObj[UpdaterHelper.UPDATER_ParameterList].Value<JArray>();
        ...
        // 
        //     string tempFile = Path.GetTempFileName() + UpdaterHelper.TextFile;  // 임시 파일의 전체 파일 경로 반환 및 string 클래스 객체 "tempFile"에 할당 
        // 
