...
using Calculator.Common.CommandBase;
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                using (Transaction transaction = new Transaction(doc))
                {
                    ...
                    transaction.Start(CommandHelper.start);  // 해당 "Calculator" 프로젝트에서 연산처리(객체 생성, 정보 변경 및 삭제 등등... ) 시작

                    // MessageBox.Show("C# 계산기 테스트");
                    // TaskDialog.Show("테스트", "C# 계산기");
                    ...
                    transaction.Commit();   // 해당 "Calculator" 프로젝트에서 연산처리(객체 생성, 정보 변경 및 삭제 등등... )된 결과 커밋
                }
